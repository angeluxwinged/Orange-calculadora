    ...
    <div class="row justify-content-center align-items-center ">
        <div class="col-md-10 mb-5">
            <form class="form bg-light p-5 form-medic d-flex" action="" method="post">
                <div class="col-md-6">
                    <h3 class="text-center mb-4">Parkland</h3>
                    <div class="form-group mb-4">
                        <label class="">Peso:</label><br>
                        <input type="text" id="pesoParkland" class="form-control focusGreen">
                    </div>

                    <div class="form-group mb-4">
                        <label class="">SCQ(%):</label><br>
                        <input type="text" id="SCQ" class="form-control focusGreen">
                    </div>
